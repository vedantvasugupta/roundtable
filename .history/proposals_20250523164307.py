...
class BaseProposalModal(discord.ui.Modal):
    ...
    async def common_on_submit(self, interaction: discord.Interaction, specific_hyperparameters: Dict[str, Any]):
        ...
        try:
            ...
            deadline_iso_str = actual_deadline_datetime.isoformat()
            ...
            proposal_id = await _create_new_proposal_entry(
                ...
                self.mechanism_name,
                options,
                deadline_iso_str, # Pass ISO string
...
async def _create_new_proposal_entry(interaction: discord.Interaction, title: str, description: str, mechanism_name: str, options: List[str], deadline_iso_str: str, hyperparameters: Optional[Dict[str, Any]] = None) -> Optional[int]:
    ...
    try:
        ...
        proposal_id = await db.create_proposal(
            ...
            mechanism_name,
            deadline_iso_str, # Use the ISO string deadline
