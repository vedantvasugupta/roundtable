...
class TokenInvestmentModal(discord.ui.Modal, title="Invest Tokens"):
    def __init__(self, base_vote_view: 'BaseVoteView', remaining_tokens: int):
        ...
        if base_vote_view.campaign_details:
            # Try to get the weight mode from the vote view or we'll need to fetch it
            # For now, we'll use a default approach, but this should be enhanced
            weight_mode = "equal"  # Will be enhanced to get from proposal hyperparameters
