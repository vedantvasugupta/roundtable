...
async def init_db() -> None:
    ...
    async with get_db() as conn:
        ...
        await _ensure_column(conn, 'servers', 'created_at TEXT NOT NULL')
        await _ensure_column(conn, 'users', 'last_updated TEXT NOT NULL')
        ...
        await _ensure_column(conn, 'proposals', 'creation_timestamp TEXT NOT NULL')
        await _ensure_column(conn, 'proposals', 'last_updated_timestamp TEXT NOT NULL')
        ...
        await _ensure_column(conn, 'votes', 'timestamp TEXT NOT NULL')
        ...
        await _ensure_column(conn, 'constitutional_variables', 'last_updated_timestamp TEXT NOT NULL')
        ...
        await _ensure_column(conn, 'voting_invites', 'timestamp TEXT NOT NULL')

        await _ensure_column(conn, 'proposal_notes', 'created_at TEXT NOT NULL')
        await _ensure_column(conn, 'warnings', 'timestamp TEXT NOT NULL')
        await _ensure_column(conn, 'temp_moderation', 'expires_at TEXT NOT NULL')

        await _ensure_column(conn, 'campaigns', 'creation_timestamp TEXT NOT NULL')
        await _ensure_column(conn, 'user_campaign_participation', 'last_updated_timestamp TEXT NOT NULL')
