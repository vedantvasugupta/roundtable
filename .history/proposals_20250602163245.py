    ...
    async def start_next_callback(self, interaction: discord.Interaction):
        ...
        if campaign['status'] == 'setup':
            ...
            if not first_scenario_to_start:
                ...
                success_init, msg_init = await voting_utils.initiate_voting_for_proposal(guild, first_scenario_to_start['id'], bot_instance, first_scenario_to_start)
                if success_init:
            ...
            if active_voting_scenarios:
                ...
                if next_scenario_order_needed > campaign['num_expected_scenarios']:
                    ...
                    if not next_scenario_to_start:
                        ...
                        success_init, msg_init = await voting_utils.initiate_voting_for_proposal(guild, next_scenario_to_start['id'], bot_instance, next_scenario_to_start)
                        if success_init:
