    ...
    async with get_db() as conn:
        ...
        async with conn.execute("SELECT * FROM proposals") as cursor:
            ...
            for proposal in proposals:
                ...
                proposal_id = proposal['proposal_id'] if has_proposal_id else proposal['id']
                created_at = proposal['created_at'] if 'created_at' in columns else None
                deadline = proposal['deadline'] if 'deadline' in columns else None
