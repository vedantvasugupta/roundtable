    ...
    try:
        ...
        if deadline_data:
            try:
                ...
                print(f"ERROR: Could not parse deadline string '{deadline_data}' in process_vote for P#{proposal_id}")
...
class BaseVoteView(discord.ui.View):
    ...
    async def submit_vote_callback(self, interaction: discord.Interaction):
        ...
        if self.is_abstain_vote: # Handled by AbstainButton's callback directly calling finalize_vote
            ...
            print(f"DEBUG: BaseVoteView.submit_vote_callback reached for abstain vote for P#{self.proposal_id}. This should be rare.")
