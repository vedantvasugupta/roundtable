...
class CampaignControlView(discord.ui.View):
    ...
    async def define_scenario_callback(self, interaction: discord.Interaction):
        # This method is called when the "Define Next Scenario" button is clicked.
        # You can implement the logic you want to execute when this button is clicked.
        await interaction.response.send_message("Define Next Scenario button clicked!", ephemeral=True)
