...
async def create_proposal(
    ...
    title: str,
    description: str,
    mechanism: str, # Changed from voting_mechanism
    deadline: str,
    requires_approval: bool = True,
    hyperparameters: Optional[Dict[str, Any]] = None,
    campaign_id: Optional[int] = None,
    scenario_order: Optional[int] = None,
    status: Optional[str] = None # Changed from initial_status
):
    ...
    # Determine status
    if not status: # If status is not provided, determine it based on requires_approval
        status_to_use = "Pending Approval" if requires_approval else "Voting"
    else:
    ...
    """
    params = (
        server_id, proposer_id, title, description_to_store,
        mechanism, deadline, requires_approval, status_to_use, hyperparameters_json,
