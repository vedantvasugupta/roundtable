...
async def test_full_integration():
    ...
    for i, voter_id in enumerate(voter_ids):
        ...
        choice = random.choice(["Candidate A", "Candidate B", "Candidate C"])
        scenario_4_votes.append((voter_id, choice, tokens_to_use))
        
        await db.record_vote(voter_id, scenario_4_id, json.dumps({"option": choice}), False, tokens_to_use)
