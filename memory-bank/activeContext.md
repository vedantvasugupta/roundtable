...
*   **COMPLETED: All Voting Mechanisms Submit Button Support:** Added submit buttons to all voting mechanisms (plurality, approval, runoff, borda) for proper token allocation and finalization flow.
